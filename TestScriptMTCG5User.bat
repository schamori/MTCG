...
REM --------------------------------------------------
echo 22) Create additional users
REM Create additional User
curl -i -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"user1\", \"Password\":\"pass1\"}"
echo.
curl -i -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"user2\", \"Password\":\"pass2\"}"
echo.
...
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo.
echo should fail (no money ((package had to taken out so new user do not buy the left over packages)):
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo.
echo.
...
echo 10) Create and Acquire packages for additional users


curl -i -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"Id\":\"waterGoblinID1\", \"Name\":\"WaterGoblin\", \"Damage\": 30.0}, {\"Id\":\"waterGoblinID2\", \"Name\":\"WaterGoblin\", \"Damage\": 35.0}, {\"Id\":\"waterGoblinID3\", \"Name\":\"WaterGoblin\", \"Damage\": 40.0}, {\"Id\":\"waterGoblinID4\", \"Name\":\"WaterGoblin\", \"Damage\": 25.0}, {\"Id\":\"waterGoblinID5\", \"Name\":\"WaterGoblin\", \"Damage\": 20.0}]"
echo.
curl -i -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"Id\":\"waterGoblinID6\", \"Name\":\"WaterGoblin\", \"Damage\": 33.0}, {\"Id\":\"waterGoblinID7\", \"Name\":\"WaterGoblin\", \"Damage\": 37.0}, {\"Id\":\"waterGoblinID8\", \"Name\":\"WaterGoblin\", \"Damage\": 42.0}, {\"Id\":\"waterGoblinID9\", \"Name\":\"WaterGoblin\", \"Damage\": 28.0}, {\"Id\":\"waterGoblinID10\", \"Name\":\"WaterGoblin\", \"Damage\": 22.0}]"
echo.


curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer user1-mtcgToken" -d ""
echo.
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer user2-mtcgToken" -d ""
echo.
echo.

REM Set deck for User1
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer user1-mtcgToken" -d "[\"waterGoblinID1\", \"waterGoblinID2\", \"waterGoblinID3\", \"waterGoblinID4\"]"
echo.
REM Set deck for User2
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer user2-mtcgToken" -d "[\"waterGoblinID6\", \"waterGoblinID7\", \"waterGoblinID8\", \"waterGoblinID9\"]"
echo.
echo.
pause
...
start /b "altenhof battlee" curl -i -X POST http://localhost:10001/battles --header "Authorization: Bearer altenhof-mtcgToken"

REM --------------------------------------------------
echo 26) Initiate battles between users
start /b "user1 battle" curl -i -X POST http://localhost:10001/battles --header "Authorization: Bearer user1-mtcgToken"
start /b "user2 battle" curl -i -X POST http://localhost:10001/battles --header "Authorization: Bearer user2-mtcgToken"
...
echo try to trade with less Damage than Mininum (should fail)

curl -i -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d "\"67f9048f-99b8-4ae4-b866-d8008d00c53d\""

echo try to trade with wrong type (should fail)

curl -i -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d "\"a6fde738-c65a-4b10-b400-6fef0fdb28ba\""
pause
